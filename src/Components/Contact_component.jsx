...
const Contacto = () => {
    ...
    return(
        <>
            <div className='w-full h-auto font-poppins mt-20 flex flex-col items-center' id="contacto">
                <h2 className='text-center text-6xl text-white'>Contacto</h2>
                <div className='w-4/5 h-96 flex flex-col items-center  mt-6 md:h-72'>
                    ...
                    <div className='flex justy-center items-center mt-3'><a href="mailto:axelwestman@outlook.com" className='flex items-center'><IoIosMail  className='text-4xl text-slate-100 mr-2 md:text-[2.50rem]'/><p className='text-white text-xl'>axelwestman@outlook.com</p></a></div>
