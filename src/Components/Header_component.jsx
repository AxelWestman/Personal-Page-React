        ...
        <>
            ...
            <div className='w-56 h-56 newphones:w-72 newphones:h-72 rounded-full flex flex-col mb-4 items-center  justify-center overflow-hidden shadow-2xl shadow-blue-500/20 md:w-60 md:h-60'>
                ...
                <div className='bg-white bg-opacity-5 w-44 h-12 mt-3 gap-2 rounded-3xl flex justify-center items-center shadow-2xl shadow-blue-500/20 md:h-10'>
                    <a href="https://github.com/AxelWestman" target='_blank'><FaGithub className='text-[2.4rem] text-slate-100 md:text-[1.9rem]'/></a>
                    <a href="https://linkedin.com/in/axel-westman-b4606a27b" target='_blank'><AiOutlineLinkedin className='text-5xl text-slate-100 md:text-4xl'/></a>
                    <a href="mailto:axelwestman@outlook.com"><IoIosMail  className='text-5xl text-slate-100 md:text-[2.50rem]'/></a>
                </div>
            </div>
        </>
    );
